        ...
        >
          ...
          <Box w={{ base: "100%", md: "50%" }}>
            ...
            <Text
              ...
              textAlign={{ base: "center", md: "start" }}
            >
              Welcome to PapaVanz Anime, a home for true anime fans. Discover trending anime, revisit legendary series, and enjoy endless entertainment crafted for every otaku—anytime, anywhere.
            </Text>
          </Box>
      ...
      <Box bg="var(--primary-background-color)" py="20px">
        ...
        >
          ...
          <Box>
            ...
            >
              &copy;
              {` ${new Date().getFullYear()} All rights reserved by PapaVanzAnime.`}
            </Text>
          </Box>
